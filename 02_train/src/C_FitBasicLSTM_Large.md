...
if remove_PB:
    data_scalars_fpath =  train_out_dir + 'large_lstm_min_max_scalars_' + str(random_seed) + '_NoProcessBasedInput_.pt'
    model_weights_fpath = train_out_dir + 'large_lstm_weights_' + str(random_seed) + '_NoProcessBasedInput_.pth'
    train_predictions_fpath = train_out_dir + 'large_lstm_train_preds_' + str(random_seed) + '_NoProcessBasedInput_.npy'
    valid_predictions_fpath = train_out_dir + 'large_lstm_valid_preds_' + str(random_seed) + '_NoProcessBasedInput_.npy'
    loss_lists_fpath = train_out_dir + 'large_lstm_loss_lists_' + str(random_seed) + '_NoProcessBasedInput_.npz'
else:
